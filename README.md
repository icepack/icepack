...
Once you've installed icepack, the directory `demo/` contains several Jupyter notebooks with demonstrations of the main features of icepack to get you started.
The directory `demo/how-to` contains more advanced material for when you've got a good feel for how things work.
